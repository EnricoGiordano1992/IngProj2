...
import comunication.ComManCar;
import comunication.Comunication;
import comunication.Message;
import comunication.Net;

public class ManCar implements InterfaceManCar,Runnable{
	...
	public ManCar(int p_rate, Net net, int tempID, ScenarioGraphic g){

		this.g = g;
		com = new ComManCar(p_rate, this, net);
		com.setId(tempID);
		ID = tempID;
		this.p_rate = p_rate;
		speed_meter = 0;
